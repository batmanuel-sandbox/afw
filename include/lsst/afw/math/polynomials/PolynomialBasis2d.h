...
#include "lsst/afw/math/polynomials/PolynomialBasis1d.h"
 ...
 */
inline ScaledPolynomialBasis2d makeScaledPolynomialBasis2d(std::size_t order, geom::Box2D const & box) {
    return ScaledPolynomialBasis2d(PolynomialBasis2d(order), makeUnitRangeScaling2d(box));
}
